...
<div id="container">
<div id="calendarWrap">
<h3 style="text-align: center;"><%= nowYear %>년 <%= nowMonth %>월</h3>
...
<%
	...
	for (int day = 1; day <= lastDay; day++) {
	    int tempDay = (startDayOfWeek + day) % 7;
	    if (tempDay == 1 && day != lastDay) {
	        out.print("</tr><tr>");
	    	out.print("<td style='color:red;'>" + day + "</td>");
	    } else if(tempDay == 0){
	    	out.print("<td style='color:blue;'>" + day + "</td>");
	    } else{
	    	out.print("<td>" + day + "</td>");
	    }
	}
