	...
	$(function() {
		...
		$("#btnUpdate").click(function() {
			...
			var uploadFlag = $("#img")[0].src.lastIndexOf("default.jpg") == -1;
				...
				var formData = new FormData(frm); //binary 전송방식: 파일 업로드 가능
...
<body>
	...
	<main>
		<div id="container">
			...
			<div>
				<h3>마이페이지</h3>
				<form action="mypage_process.jsp" id="frm" method="post" name="frm">
					<div style="float: Left">
						<img src="${mDTO.profile_img eq 'default.jpg'?"../common/images":uploadURL}/${mDTO.profile_img}"
							style="width: 130px; height: 140px" id="img" /> <br> <input
							type="button" value="이미지선택" id="btnImg"
							class="btn btn-info btn-sm" /> <input type="hidden" name="img"
							id="imgName" /> <input type="file" style="display: none"
					...
					<table style="float: Left; clear: both;">
						...
						<tr>
							<td colspan="2" style="text-align: center"><input
								type="button" id="btnUpdate" value="정보변경" class="btn btn-info" />
							</td>
						</tr>
					</table>
				</form>
