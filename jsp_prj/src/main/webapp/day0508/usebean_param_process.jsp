...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="useBean action 태그로 web parameter 한방에 받기"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<li><label>checkbox 하나</label> : <!-- 체크박스가 하나인 경우 checked되면 value가 checked 되지 않으면 null -->
<jsp:getProperty property="file" name="param"/></li>
